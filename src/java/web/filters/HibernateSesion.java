 ...
 * @author yehor
 */
@WebFilter(filterName = "HibernateSesion", urlPatterns = {"/pages/*", "/PdfContent"})
public class HibernateSesion implements Filter {
    ...
    public HibernateSesion() {
    }    
    
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("HibernateSesion:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("HibernateSesion:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        sesionFactory.getCurrentSession().beginTransaction();
        ...
        try{
            sesionFactory.getCurrentSession().beginTransaction().commit();
        }catch(Exception e)
        {
            if(sesionFactory.getCurrentSession().getTransaction().isActive())
                sesionFactory.getCurrentSession().getTransaction().rollback();
        }
        System.out.println("closing session for " + wrappedRequest.getRequestURL().toString());
    ...
    public void init(FilterConfig filterConfig) {   
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("HibernateSesion: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("HibernateSesion()");
        }
        StringBuffer sb = new StringBuffer("HibernateSesion(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("HibernateSesion::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("HibernateSesion::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("HibernateSesion::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("HibernateSesion::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("HibernateSesion::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
